...
const faqs = [
  ...
  {
    question: '取消或改期時，訂金如何處理？',
    answer:
      '如需取消或改期，請儘早告知。預約時間前 6 小時以上通知，訂金可保留一次並於 30 天內改期使用；預約前 2–6 小時通知，訂金保留 50%，另 50% 可轉為改期金。預約前 2 小時內取消、未通知取消，或預約時間後 15 分鐘仍未到且無法聯絡者，將視為 No-show，訂金恕不退還。改期限一次，且須於指定期限內使用；若遇突發疾病、交通事故或其他重大緊急狀況，歡迎主動聯繫，深寓會視情況協助處理。曾有 No-show 紀錄者，後續預約可能需全額預付。',
  },
  {
    question: '空間會有其他客人嗎？',
    answer:
